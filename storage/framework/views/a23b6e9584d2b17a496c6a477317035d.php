...
<body>
    ...
    <nav class="navbar navbar-expand-lg px-4">
        ...
        <div class="ms-auto d-flex align-items-center">
            <span class="me-3 fw-semibold text-secondary">
                👋 Hello, <?php echo e(Auth::user()->name ?? 'User'); ?>

            </span>
            <button class="dark-mode-toggle" id="darkModeBtn" title="Toggle Dark Mode">
                <i class="bi bi-moon-stars"></i>
            </button>
            <a href="<?php echo e(route('account.logout')); ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3 ms-3">
    ...
    <div class="sidebar" id="sidebar">
        <a href="<?php echo e(route('account.dashboard')); ?>" class="<?php echo e(request()->routeIs('account.dashboard') ? 'active' : ''); ?>">
            <i class="bi bi-house-door"></i> <span>Dashboard</span>
        </a>
        <a href="<?php echo e(route('account.categories')); ?>" class="<?php echo e(request()->routeIs('account.categories') ? 'active' : ''); ?>">
            <i class="bi bi-tags"></i> <span>Categories</span>
        </a>
        <a href="<?php echo e(route('account.products')); ?>" class="<?php echo e(request()->routeIs('account.products') ? 'active' : ''); ?>">
    ...
    <main class="main-content">
        ...
        <footer>
            © <?php echo e(date('Y')); ?> <strong>Ecommerce User Panel</strong>. All rights reserved.
        </footer>
    </main>
