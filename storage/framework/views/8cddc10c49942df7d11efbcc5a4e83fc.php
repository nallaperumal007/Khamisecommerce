...
<body>
  ...
  <nav class="navbar navbar-expand-lg sticky-top shadow-sm">
   ...
   <img src="<?php echo e(asset('storage/logo.png')); ?>" alt="Khamis" height="50">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarMenu">
        <ul class="navbar-nav align-items-center gap-3">
          ...
          <li><a class="nav-link" href="<?php echo e(route('category')); ?>">CATEGORY</a></li>
  ...
  <footer class="mt-5">
    ...
    <div class="footer-bottom text-center mt-4">
      © <?php echo e(date('Y')); ?>. All rights reserved. | Asraaz Business Solutions
    </div>
  </footer>
...
<?php /**PATH D:\Ecommerce\resources\views/layout/app.blade.php ENDPATH**/ ?>