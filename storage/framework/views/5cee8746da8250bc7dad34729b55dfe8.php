...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
            ...
            <a href="<?php echo e(route('user.category')); ?>" class="btn btn-outline-success mt-3">
                ← Back to Categories
            </a>
        </div>
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="fw-semibold"><?php echo e($product->name); ?></h5>
                            <p class="text-success fw-bold mb-2">₹<?php echo e(number_format($product->price, 2)); ?></p>
...
<?php echo $__env->make('includes.cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- same cart modal include -->
