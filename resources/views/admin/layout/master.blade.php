    ...
    <nav class="navbar d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="profile-info">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::guard('admin')->user()->name ?? 'Admin') }}&background=4e73df&color=fff" alt="Admin Avatar">
                <span class="fw-semibold">{{ Auth::guard('admin')->user()->name ?? 'Admin' }}</span>
                <a href="{{ route('admin.logout') }}" class="btn btn-outline-light btn-sm ms-3">
